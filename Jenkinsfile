node {
                      ...
                      stage ('deploy') {
                        ...
                        sh 'docker service create --name microservice-spring-reactor --publish 9991:8080 --network microservices-net --replicas 2 mitosis/microservice-spring-reactor:1'
                     }
                }